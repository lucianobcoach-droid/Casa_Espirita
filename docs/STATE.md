...
- a auditoria ja possui captura inicial em `LancamentoFinanceiro`, `ContaFinanceira`, `PessoaFinanceira` e `CategoriaFinanceira`, tela propria de leitura minima e filtros simples
- nesta primeira expansao, a auditoria ainda nao foi estendida para centros de custo, assinaturas ou configuracao institucional

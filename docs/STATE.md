...
- O retorno visual da importacao agora destaca o resultado em um banner superior de sucesso ou erro, mantem os totais em cards de leitura rapida e apresenta cada linha com erro em blocos mais escaneaveis, com rotulo amigavel do campo e mensagem operacional curta.

...
- Em `Recibos em lote`, o detalhamento visual do documento deve listar os lancamentos individualmente, uma linha por lancamento, com data, descricao, documento e valor; a consolidacao permanece apenas no valor total do recibo e nao deve aparecer como linha unica no detalhamento.

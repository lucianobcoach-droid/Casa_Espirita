...
from .views import (
    ...
    PessoaFinanceiraRecorrenciaToggleView,
...
urlpatterns = [
    ...
    path(
        'controles-internos/tabelas-personalizadas/<int:tabela_id>/colunas/<int:pk>/excluir/',
        TabelaPersonalizadaColunaDeleteView.as_view(),
        name='tabela-personalizada-coluna-delete',
    ),
    path(
        'controles-internos/tabelas-personalizadas/<int:tabela_id>/colunas/<int:pk>/acao/',
        TabelaPersonalizadaColunaAcaoView.as_view(),
        name='tabela-personalizada-coluna-action',
    ),
    path(
    ...
    path(
        'controles-internos/tabelas-personalizadas/<int:tabela_id>/linhas/<int:pk>/excluir/',
        TabelaPersonalizadaLinhaDeleteView.as_view(),
        name='tabela-personalizada-linha-delete',
    ),
    path(
        'controles-internos/tabelas-personalizadas/<int:tabela_id>/linhas/<int:pk>/acao/',
        TabelaPersonalizadaLinhaAcaoView.as_view(),
        name='tabela-personalizada-linha-action',
    ),
    ...
    path(
        'pessoas/<int:pk>/alternar-recorrencia/',
        PessoaFinanceiraRecorrenciaToggleView.as_view(),
        name='pessoa-recorrencia-toggle',
    ),
